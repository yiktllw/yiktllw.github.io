import{c as D}from"./copy-BNUq0S91.js";import{d as O,r as g,n as L,o as P,b as X,c as p,a as n,e as f,t as o,u as e,F as y,f as A,g as j,h as b,i as E,j as K,k as r}from"./index-CcTAEEnv.js";import"https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.esm.min.mjs";const $={class:"blog-container",ref:"container"},N={class:"blog-info"},U={class:"blog-title"},V=["data-open"],W={class:"line-numbers"},Y={class:"top-line"},z=["src"],G=["data-open"],J={class:"line-numbers"},R={class:"top-line"},H=["src"],Q={class:"sidebar-placeholder"},Z={class:"sidebar-container"},ss={class:"nav"},ns={class:"nav-content"},as={class:"article toc active",id:"article"},ts={class:"depth-0"},es={class:"info"},ls={class:"create-time"},is={class:"last-update"},os={class:"reading-time"},cs={key:0,class:"category"},ps={key:1,class:"series"},rs={key:2,class:"tags"},fs=O({__name:"xcmusic01",setup(ms){const w=g(),m=g([]),u=g(0),B=()=>{const a=(document.documentElement.scrollTop||document.body.scrollTop)+100;let s=0;for(const[t,d]of m.value.entries())if(a>d)if(m.value[t+1]&&a<m.value[t+1]){s=t;break}else t===m.value.length-1&&(s=t);s!==u.value&&(u.value=s)};L(()=>{document.querySelectorAll(".blog h2, .blog h3, .blog h4, .blog h5, .blog h6").forEach(s=>{m.value.push(s.offsetTop)}),m.value.map(s=>-s),m.value.sort((s,t)=>s-t),document.addEventListener("scroll",B)}),P(()=>{document.removeEventListener("scroll",B)});const C=a=>{const s=document.getElementById(a),t=document.getElementById(a==="article"?"site":"article");t?(t.classList.remove("active"),s&&(s.style.display="block",s.style.position="absolute"),setTimeout(()=>{s&&(s.classList.add("active"),s.style.position="initial"),t.style.display="none"},200)):s&&s.classList.add("active");const d=document.getElementById("nav_"+a),h=document.getElementById("nav_"+(a==="article"?"site":"article"));d&&d.classList.add("selected"),h&&h.classList.remove("selected")},c=document.createElement("script");c.src="https://utteranc.es/client.js",c.setAttribute("repo","yiktllw/yiktllw.github.io"),c.setAttribute("issue-term","2025/04/xcmusic01"),c.setAttribute("label","💬comment"),c.setAttribute("theme",`github-${window.theme??"dark"}`),c.setAttribute("crossorigin","anonymous"),c.setAttribute("async","true"),L(()=>{var a,s,t;(a=w.value)==null||a.appendChild(c),(s=window.mermaid)==null||s.initialize({startOnLoad:!1,theme:window.theme==="dark"?"dark":"default"}),(t=window.mermaid)==null||t.run()});const l=X.find(a=>a.component==="@/blogs/2025/04/xcmusic01.vue");document.title=(l==null?void 0:l.blogInfo.title)??"yiktllw的博客";const M=[`<!-- 逐字歌词动画 -->
<span
...
`],_=a=>{const s=M[a];navigator.clipboard.writeText(s)},v=g([!0,!0]),k=a=>{v.value[a]=!v.value[a]};return(a,s)=>{var t,d,h,q,T,x,S,F,I;return r(),p("div",$,[n("div",{class:"blog",ref_key:"blog",ref:w},[n("div",N,[n("h1",U,o(((t=e(l))==null?void 0:t.blogInfo.title)??"Untitled"),1)]),s[8]||(s[8]=f('<p> 网易云音乐的歌词 api 返回的歌词类型有两种：逐行歌词（lrc）和逐字歌词（yrc）。 </p><h2 id="%E7%9B%AE%E6%A0%87" tabindex="-1">目标</h2><p>需要实现的歌词动画包括：</p><ol><li>滚动动画：平滑滚动到当前行</li><li>缩放动画：当前行的缩放从 1.0 缓变为 1.3，上一行反向变化</li><li>逐字歌词动画：从左到右的剪切效果</li></ol><p>逐行歌词可视为逐字歌词的特例：即动画长度为 0 的逐字歌词。</p><h2 id="%E5%88%9D%E4%BB%A3%E6%96%B9%E6%A1%88%EF%BC%9A%E5%9F%BA%E4%BA%8E-css-%E5%8A%A8%E7%94%BB%E7%9A%84%E5%AE%9E%E7%8E%B0" tabindex="-1"> 初代方案：基于 CSS 动画的实现 </h2><p> 初版应用于 XCMusic <a href="https://github.com/yiktllw/XCMusic/releases/tag/0.2.4">0.2.4</a> 及之前版本。 </p><p>主要原理是：</p><ol><li>用 <code>requestAnimationFrame</code> 计算滚动动画位置</li><li>CSS 动画处理缩放效果；</li><li><code>clip-path</code> 实现逐字动画，动画时长对应歌词时间</li></ol>',9)),n("pre",null,[n("code",{"data-open":v.value[0],class:"hljs language-vue",style:{"font-family":"yiktllw-code, serif",position:"relative"}},[n("div",W,[(r(),p(y,null,A(15,i=>n("span",null,o(i),1)),64))]),n("div",Y,[n("div",{onClick:s[0]||(s[0]=i=>k(0)),class:"language"},"<VUE>"),n("div",{class:"copy-button",onClick:s[1]||(s[1]=i=>_(0))},[n("img",{class:"copy-img",src:e(D)},null,8,z)])]),s[6]||(s[6]=f(`<div class="code"><span class="language-xml"><span class="hljs-comment">&lt;!-- 逐字歌词动画 --&gt;</span>
...
</div>`,1))],8,G)]),s[10]||(s[10]=f('<hr class="footnotes-sep"><section class="footnotes"><ol class="footnotes-list"><li id="fn1" class="footnote-item"><p><a href="https://music.163.com/song?id=22256832">贝多芬第九交响曲。富特文格勒 / 1951 年拜罗伊特音乐节, 网易云音乐 id: 22256832</a><a href="#fnref1" class="footnote-backref">↩︎</a></p></li></ol></section>',2))],512),n("div",Q,[n("div",Z,[n("div",ss,[n("div",{class:"nav-item selected",id:"nav_article",onClick:s[4]||(s[4]=i=>C("article"))}," 文章信息 "),n("div",{class:"nav-item",id:"nav_site",onClick:s[5]||(s[5]=i=>C("site"))}," 站点概览 ")]),n("div",ns,[n("div",as,[s[18]||(s[18]=n("div",{class:"toc-title"},"目录",-1)),s[19]||(s[19]=n("div",{class:"progress-bar"},null,-1)),n("ul",ts,[n("li",null,[n("a",{href:"#%E7%9B%AE%E6%A0%87",class:j(u.value===0?"active":"not-active")},"1 目标",2)]),n("li",null,[n("a",{href:"#%E5%88%9D%E4%BB%A3%E6%96%B9%E6%A1%88%EF%BC%9A%E5%9F%BA%E4%BA%8E-css-%E5%8A%A8%E7%94%BB%E7%9A%84%E5%AE%9E%E7%8E%B0",class:j(u.value===1?"active":"not-active")},"2 初代方案：基于 CSS 动画的实现",2)]),n("li",null,[n("a",{href:"#%E4%BA%8C%E4%BB%A3%E6%96%B9%E6%A1%88%EF%BC%9A%E4%BD%BF%E7%94%A8-canvas-%E7%BB%98%E5%88%B6%E6%AD%8C%E8%AF%8D",class:j(u.value===2?"active":"not-active")},"3 二代方案：使用 Canvas 绘制歌词",2)]),n("li",null,[n("a",{href:"#%E6%9C%80%E7%BB%88%E7%89%88%E6%9C%AC%EF%BC%9A%E5%9F%BA%E4%BA%8E-web-animations-api-%E5%92%8C-css-%E7%9A%84%E6%AD%8C%E8%AF%8D%E5%8A%A8%E7%94%BB",class:j(u.value===3?"active":"not-active")},"4 最终版本：基于 Web Animations API 和 CSS 的歌词动画",2)])]),n("div",es,[n("span",ls,[s[11]||(s[11]=n("span",{class:"ele-title"},"创建于：",-1)),E(o(e(K)(((d=e(l))==null?void 0:d.blogInfo.createTime)??0)),1)]),n("span",is,[s[12]||(s[12]=n("span",{class:"ele-title"},"修改于：",-1)),E(o(e(K)(((h=e(l))==null?void 0:h.blogInfo.lastUpdate)??0)),1)]),n("span",os,[s[13]||(s[13]=n("span",{class:"ele-title"},"预计阅读时间：",-1)),E(o((q=e(l))==null?void 0:q.blogInfo.readingTime)+"分钟 ",1)]),((T=e(l))==null?void 0:T.blogInfo.category)!=="default"?(r(),p("span",cs,[s[14]||(s[14]=n("span",{class:"ele-title"},"分类于：",-1)),E(o((x=e(l))==null?void 0:x.blogInfo.category),1)])):b("",!0),(S=e(l))!=null&&S.blogInfo.series.enable?(r(),p("span",ps,[s[15]||(s[15]=n("span",{class:"ele-title"},"系列：",-1)),E(o((F=e(l))==null?void 0:F.blogInfo.series.name),1)])):b("",!0),s[17]||(s[17]=n("span",{class:"copy-right"},[n("span",{class:"ele-title"},"许可协议："),n("p",{"xmlns:cc":"http://creativecommons.org/ns#"},[n("a",{href:"https://creativecommons.org/licenses/by-nc-sa/4.0/?ref=chooser-v1",target:"_blank",rel:"license noopener noreferrer",style:{display:"inline-block"}},"CC BY-NC-SA 4.0")])],-1)),e(l)&&e(l).blogInfo.tags.length>0?(r(),p("span",rs,[s[16]||(s[16]=n("span",{class:"ele-title"},"标签：",-1)),(r(!0),p(y,null,A((I=e(l))==null?void 0:I.blogInfo.tags,i=>(r(),p("span",{class:"tag",key:i},o(i),1))),128))])):b("",!0)])]),s[20]||(s[20]=n("div",{class:"site",id:"site"},"标签2的内容",-1))])])])],512)}}});export{fs as default};
